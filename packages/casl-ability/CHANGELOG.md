...
## [8.0.0](https://github.com/cookieMonsterDev/casl/compare/@casl/ability@7.0.0...@casl/ability@8.0.0) (2026-06-20)
...
* **deps:** update react and removes old react and casl/ability support (major) ([#998](https://github.com/cookieMonsterDev/casl/issues/998)) ([44d3f40](https://github.com/cookieMonsterDev/casl/commit/44d3f40cb034fbd5abfd7f7014bb28baf75ef06a))


### Features

* added origin field to Rule class ([#752](https://github.com/cookieMonsterDev/casl/issues/752)) ([073d355](https://github.com/cookieMonsterDev/casl/commit/073d355cb108f333ded6cbc03ad0305ac4595295))
* adds `actionsFor(subjectType)` method that returns all actions associated with particular subject type ([f2d7e17](https://github.com/cookieMonsterDev/casl/commit/f2d7e175e9d987bcb8f89936c519df3a5c0b63ac)), closes [#497](https://github.com/cookieMonsterDev/casl/issues/497)
* adds possibility to auto detect subject type based on passed rules ([#882](https://github.com/cookieMonsterDev/casl/issues/882)) ([4737fe2](https://github.com/cookieMonsterDev/casl/commit/4737fe2270a5ce582dfcdba63c986865e3eb82c3))
* adds possibility to build Ability instance from factory function ([53d199f](https://github.com/cookieMonsterDev/casl/commit/53d199f6dcdf812b4af7d364d2cf1ba4eebdf022))
* adds return type  to 'rulesToQuery' based on return type from 'convert' param ([#876](https://github.com/cookieMonsterDev/casl/issues/876)) ([379e130](https://github.com/cookieMonsterDev/casl/commit/379e130d78eab470f672eb62b8378e243e798ab0))
* Angular 13 support ([#632](https://github.com/cookieMonsterDev/casl/issues/632)) ([6b86fd9](https://github.com/cookieMonsterDev/casl/commit/6b86fd9e7a3bdd6bd40fea032372a826cd72c0fe))
* export the Rule and RuleOptions types ([#1077](https://github.com/cookieMonsterDev/casl/issues/1077)) ([c6c94d8](https://github.com/cookieMonsterDev/casl/commit/c6c94d8f15da80262930f6eb32f708f1b030665e))
...
* refactors extra subpackage in casl/ability and adds AccessibleFields helper class ([#883](https://github.com/cookieMonsterDev/casl/issues/883)) ([9d2ad70](https://github.com/cookieMonsterDev/casl/commit/9d2ad70e6f61dc6f12c8aeb2d53f9cfd5ba23b69))
* updates createMongoAbility function signature to accept AppAbility as generic type ([f4a466c](https://github.com/cookieMonsterDev/casl/commit/f4a466c7c085fd4da3783371aed9545a32570e9a))


### Bug Fixes

* **ability:** negates inverted rules in ruleToAST ([#602](https://github.com/cookieMonsterDev/casl/issues/602)) ([c1bdc60](https://github.com/cookieMonsterDev/casl/commit/c1bdc601d3517a2385a3a7d70f2d9631c5b1f243))
...
* adds jsdoc comments ([#768](https://github.com/cookieMonsterDev/casl/issues/768)) ([6ca6105](https://github.com/cookieMonsterDev/casl/commit/6ca6105240e2a072f053f5d38b2c5c920f9d31b9))
* adds jsdoc comments to test release trigger ([#766](https://github.com/cookieMonsterDev/casl/issues/766)) ([fcdf8c8](https://github.com/cookieMonsterDev/casl/commit/fcdf8c87798c438427c3df65fa5e537cf92dd195))
* adds unlessCan method to ForbiddenError and reused it mongoose package to construct ForbiddenError ([be7ae6a](https://github.com/cookieMonsterDev/casl/commit/be7ae6aa7694394e31ddf2d2fcf560fef4b792e2))
* **builder:** makes AbilityBuilder bound methods define as arrow functions ([e724741](https://github.com/cookieMonsterDev/casl/commit/e724741e9e2ae54511f19ef3d34231932e3c744e)), closes [#736](https://github.com/cookieMonsterDev/casl/issues/736)
* defensive protection against undefined returned from rule conditions matcher ([3f0ad4b](https://github.com/cookieMonsterDev/casl/commit/3f0ad4b74c3253db0191dca805a8a4e126e6ad4e))
...
* ensure rules index cache is not polluted with not defined actions ([#1228](https://github.com/cookieMonsterDev/casl/issues/1228)) ([89c19ba](https://github.com/cookieMonsterDev/casl/commit/89c19ba93de0dbb11211aac5ac0c6eac1e58c637))
* ensures `packRule` helper doesn't stuck inside infinite loop when invalid parameters are passed ([a19bd09](https://github.com/cookieMonsterDev/casl/commit/a19bd09030d7bb33912b681d05d3040cd4275a49)), closes [#705](https://github.com/cookieMonsterDev/casl/issues/705)
* exports private continer property to get rid of ts error ([6ffdb14](https://github.com/cookieMonsterDev/casl/commit/6ffdb14466d6709ca391c9d5cd20e38b224de95e)), closes [#608](https://github.com/cookieMonsterDev/casl/issues/608)
* fixes `CreateAbility` type typos and wrong types in parameters ([aaec82d](https://github.com/cookieMonsterDev/casl/commit/aaec82d7836542359a84284207208bc66153b02f))
* fixes MongoQuery type for typescript ^4.8.x ([4af7c39](https://github.com/cookieMonsterDev/casl/commit/4af7c394bb755c0a9ffb3b96ac994588a358a77c)), closes [#673](https://github.com/cookieMonsterDev/casl/issues/673)
* fixes path to extra submodule in package.json ([#893](https://github.com/cookieMonsterDev/casl/issues/893)) ([90e1e66](https://github.com/cookieMonsterDev/casl/commit/90e1e66ef5f5a4d958616e7615ae2971c32379d8))
* ignores potentially insecure fields in rulesToFields ([#1093](https://github.com/cookieMonsterDev/casl/issues/1093)) ([39da920](https://github.com/cookieMonsterDev/casl/commit/39da920ec1dfadf3655e28bd0389e960ac6871f4))
* removes release testing comments ([#767](https://github.com/cookieMonsterDev/casl/issues/767)) ([67ccbc9](https://github.com/cookieMonsterDev/casl/commit/67ccbc989f20e3f98adaa97bb0c8126fbe28ee75))
* replaces object.hasOwnProperty with static calls to Object.hasOwn (+ polyfill) ([22fa7f8](https://github.com/cookieMonsterDev/casl/commit/22fa7f874438f2c3bcfec7fae357e64c5d8b3610)), closes [#604](https://github.com/cookieMonsterDev/casl/issues/604)
* treats empty conditions object as matches all ([#1198](https://github.com/cookieMonsterDev/casl/issues/1198)) ([cedc463](https://github.com/cookieMonsterDev/casl/commit/cedc463d1e21a65c98f245457ea71937df19308d)), closes [#684](https://github.com/cookieMonsterDev/casl/issues/684)


### Code Refactoring

* adds comments to rulesToQuery and Rule matching and adds more tests ([#950](https://github.com/cookieMonsterDev/casl/issues/950)) ([7452962](https://github.com/cookieMonsterDev/casl/commit/7452962e1db617f7cb3bc0514d32e53f0b05ed15))
* makes public constructor of ForbiddenError ([#952](https://github.com/cookieMonsterDev/casl/issues/952)) ([120429c](https://github.com/cookieMonsterDev/casl/commit/120429c5c19cd6e8bdc7a1ef7aeed05ac0d9d2f7))
* removes `getDefaultErrorMessage` exported function as unneeded ([#1206](https://github.com/cookieMonsterDev/casl/issues/1206)) ([3f56353](https://github.com/cookieMonsterDev/casl/commit/3f56353ba3fd76f6fe10384ad5f8941b290051e9))
* renames PureAbility to Ability ([#1205](https://github.com/cookieMonsterDev/casl/issues/1205)) ([97beee4](https://github.com/cookieMonsterDev/casl/commit/97beee4ff65abe102a038a27907b6e9cae191ea3))
